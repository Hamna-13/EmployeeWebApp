  ...
  return (
    <div className="bg-white h-16 px-4 flex items-center border-b border-gray-200 justify-between w-full">
      <div className="flex items-center gap-2 w-full max-w-[100%]">
        ...
        <div className="relative flex-1 max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-[350px]">
          <HiOutlineSearch
            fontSize={20}
          ...
          <input
            type="text"
            placeholder="Search..."
            className="text-sm w-full focus:outline-none active:outline-none border border-gray-300 h-10 pl-10 pr-4 rounded-sm"
          />
        </div>
      </div>
